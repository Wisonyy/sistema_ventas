                                   ...
                                   foreach ($productos_datos as $productos_dato){
                                       ...
                                       <tr>
                                           ...
                                           if ($stock_actual < $stock_minimo) {?>
                                                <td style="background-color:rgb(241, 137, 130)"><center><?php echo $productos_dato['stock'];?></center></td>
                                            <?php
                                            }
                                           else if ($stock_actual > $stock_maximo) { ?>
                                                <td style="background-color:rgb(143, 240, 143)"><center><?php echo $productos_dato['stock'];?></center></td>
                                           <?php
                                           }else {  ?>
