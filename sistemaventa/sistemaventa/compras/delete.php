                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="stock" value="<?= $stock; ?>" id="stock" class="form-control" style="background-color:rgb(227, 247, 46)" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="precio_compra" value="<?= $precio_compra; ?>" id="precio_compra" class="form-control" disabled>
                                                        </div> 
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" style="font-size: 11px" name="fecha_ingreso" value="<?= $fecha_ingreso; ?>" id="fecha_ingreso" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $id_compra_get;?>" style="text-align" class="form-control" disabled>
                                        ...
                                        <script>
                                            $('#btn_eliminar').click(function () {
                                                ...
                                                function eliminar() {
                                                    ...
                                                    $.get(url,{id_compra:id_compra,id_producto:id_producto,cantidad_compra:cantidad_compra,stock_actual:stock_actual
