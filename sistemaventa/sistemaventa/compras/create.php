                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="stock" id="stock" class="form-control" style="background-color:rgb(227, 247, 46)" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $contador_de_compras;?>" style="text-align" class="form-control" disabled>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" style="background-color:rgb(234, 250, 9);text-align: center" id="stock_actual" class="form-control" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
