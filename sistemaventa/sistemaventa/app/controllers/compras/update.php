...
if ($cantidad_compra <= 0 || $precio_compra < 0 || $stock_total < 0) {
    session_start();
    $_SESSION['mensaje'] = "Error: No se permiten valores negativos ni cantidad cero.";
...
// ✅ Iniciar transacción si los datos son válidos
