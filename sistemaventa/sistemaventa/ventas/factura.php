...
<tr>
    ...
    <img src="../public/images/logo.jpg" width="80px" alt=""> <br><br>
        <b>SISTEMA DE VENTAS RATA E.I.R.L </b> <br>
    Manco Capac av. 7 Cajones #300 <br>
    959717822 - 962701585  <br>
    ESPINAR-CUSCO-PERÚ
    </td>
    <td style="width: 150px"></td>
    <td style="font-size: 16px;width: 290px"><br><br><br>
        <b>RUC: </b>34510965801 <br>
        <b>Nro factura:</b> '.$id_venta_get.' <br>
        <b>Nro de autorización: </b>765432189
        <p style="text-align: center"><B>ORIGINAL</B></p>
    </td>
</tr>
</table>

<p style="text-align: center;font-size: 25px"><b>FACTURA ELECTRÓNICA</b></p>
...
foreach ($carrito_datos as $carrito_dato){
    ...
    <tr>
        ...
        <td style="text-align: center">PEN. '.$carrito_dato['precio_venta'].'</td>
        <td style="text-align: center">PEN. '.$subtotal.'</td>
    </tr>
    ';
...
<tr>
    ...
    <td style="text-align: center;background-color: #d6d6d6">PEN. '.$precio_unitario_total.'</td>
    <td style="text-align: center;background-color: #d6d6d6">PEN. '.$precio_total.'</td>
</tr>
</table>

<p style="text-align: right">
         <b>Monto Total: </b> PEN. '.$precio_total.'
        </p>
        <p>
...
$QR = 'Factura realizada por el sistema de ventas FRANKLIN GUSTAVO, al cliente '.$nombre_cliente.' con DNI: '.$nit_ci_cliente.' 
